...
/*	if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts')){
	...
	if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='sumanthpotluri')){
     $y="select quet_num,state,user,gstamt,gsttype from odrequest_amnt where confirm='Yes' and status='Amount Transferred' and date >= '$fromdate' and date <='$todate' order by id desc";
	}else{
	$y="select  quet_num,state,user,gstamt,gsttype from odrequest_amnt where confirm='Yes' and status='Amount Transferred' and user='$tsname' and date >='$fromdate' and date<='$todate' order by id desc";
	}
...
while($row	=	$result->fetch_assoc()){
	...
	$tyy="select sum(req_amnt+gstamt) as rsamt from odrequest_amnt where quet_num='$qot' and confirm='Yes'";
