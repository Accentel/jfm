                                                   ...
                                                   <td>
                                                       ...
                                                       ?>
                                                        ...
                                                        <td class="hidden-480">
                                                            ...
                                                            <?php if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='apbilling')or ($tsname=='sumanthpotluri') ){ ?>
...
if($bsearch!=''){
											...
											$sql="select count(1) as total from qot_bill where status='RUn Paid' and quet_num like  '%$bsearch%' ";
													  } else {
													       if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='apbilling')or ($tsname=='sumanthpotluri')){
													           $sql="select count(1) as total from qot_bill where status='RUn Paid' ";
													      }else{
													           $sql="select count(1) as total from qot_bill where status='RUn Paid' and user='$tsname'    ";
													      }
...
{
if(($i+1)==$page) 
echo "<li><a href='bill_list31.php?page=".($i+1)."' class='button' style='color:red'>".($i+1)."</a></li>";
else
echo "<li><a href='bill_list31.php?page=".($i+1)."' class='button'>".($i+1)."</a></li>";
}
