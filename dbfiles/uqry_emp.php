...
if (isset($_POST['submit'])) {
 ...
 //if the form variables are not empty then update data into database
       ...
       $sql = "update employee set emp_name='$emp_name',DOB ='$dob',gender='$gender',maritalstatus='$maritalstatus',contactno='$contactno',alternateno='$alternateno',
       adharcardno='$adharcardno',address='$address',city='$city',state='$state',qualification='$qualification',experience='$experience',DOJ='$DOJ',
