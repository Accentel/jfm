...
$objPHPExcel->getActiveSheet()->getStyle("A4:AC4")->getFont()->setBold(true)->getColor()->setRGB('ffffff');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'ANDHRA PRADESH APPROVED AMOUNT LIST');
...
while($row	=	$result->fetch_assoc()){
    ...
    $krid=$row['id'];
    $ac=$row['ac_det'];
    $a="select store_code,ro_no,ro_date,falt_desc,tot_base,tot_ser,tot_gst,adv_amnt,adv_amnt1,adv_amnt2,gst_type,net,bal,invoice_date,invoice_no from add_qot where quet_num='$qot'";
