...
$objPHPExcel->getActiveSheet()->setCellValue('C21', AP);
...
include_once('dbconnection/connection.php');
 $aa="select  @acount:=@acount+1 sno,gst,hsn,serv_code,desc1,brand,model,qty,uom,rate,base_amt,serv_amt,(base_amt+serv_amt) as total,gst_amnt  from (SELECT @acount:= 0) AS acount,add_qot1 where  id1='$bid' ";
