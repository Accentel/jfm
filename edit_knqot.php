...
?>
										...
										<img src="upload/<?php echo $r['img1'];?>" onclick="window.open('knqut_image.php?id=<?php echo $r['img1'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;">
										</td>
										<td align="right">Image2</td><td align="left">
										<input type="file" name="imagea">
										<img src="upload/<?php echo $r['img2'];?>" onclick="window.open('knqut_image.php?id=<?php echo $r['img2'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
                                        </tr>
										<tr>	
                                        <td align="right">Image3 </td><td>
										<input type="file" name="imageb">
										<img src="upload/<?php echo $r['img3'];?>" onclick="window.open('knqut_image.php?id=<?php echo $r['img3'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;">
										</td>
                                        </tr>
                                    <tr><td colspan="2"><b>After Images</b></td></tr>
										...
										<img src="upload/<?php echo $r['img4'];?>" onclick="window.open('knqut_image.php?id=<?php echo $r['img4'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;">
										</td>
										<td align="right">Image5</td><td align="left">
										<input type="file" name="image5">
										<img src="upload/<?php echo $r['img5'];?>" onclick="window.open('knqut_image.php?id=<?php echo $r['img5'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
                                        </tr>
										<tr>	
                                        <td align="right">Image6 </td><td>
										<input type="file" name="image6">
										<img src="upload/<?php echo $r['img6'];?>" onclick="window.open('knqut_image.php?id=<?php echo $r['img6'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;">
										</td>
                                        </tr>
