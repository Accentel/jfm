...
if($qt_no1!=''){
	...
	$tr=mysqli_fetch_array($t);
	 $empemail=$tr['emp_email'];
	  ...
	  $a="INSERT INTO `add_knqot`(`store_code`, `inv_date`, `quet_num`, `tot_base`, `tot_ser`, `tot_gst`, `net`,  `ses`,falt_no,falt_date,falt_desc,status,img1,img2,img3)
...
$model=$_POST['model'][$i];
 ...
 $query = "INSERT INTO add_knqot1 ( `desc1`, `hsn`, `gst`, `uom`, `qty`, `gst_amnt`, `rate`, `base_amt`,`date`,`id1`,item_id,serv_fee,cap,serv_amt,serv_code,serv_cap,brand,model,remarks) 
	VALUES 
