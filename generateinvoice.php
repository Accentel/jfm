...
<td colspan="1"><b >State: </b><?php if($state1=='AP') echo 'Andhra Pradesh';?></td>
</tr>
<tr>
...
<tr><td colspan="2"> 
    <b>State:</b><?php echo  'Andhra Pradesh' ?>
</td>
<td colspan="2">
    <b>State: </b><?php  if($state1=='AP') echo 'Andhra Pradesh';?>
</td>
</tr>
<tr><td colspan="2"> 
    <b>State Code: </b>37
...
<?php include_once('dbconnection/connection.php');
 $ak="select @acount:=@acount+1 sno,hsn,gst,sum((base_amt+serv_amt)) as total,sum(gst_amnt) as gst_amnt from (SELECT @acount:= 0) AS acount,add_qot1 where id1='$bid'   group by hsn,gst order by sno";
...
include_once('dbconnection/connection.php');
 $aa="select  @acount:=@acount+1 sno,hsn,gst,serv_code,desc1,brand,model,qty,uom,rate,base_amt,serv_amt,(base_amt+serv_amt) as total,gst_amnt  from (SELECT @acount:= 0) AS acount,add_qot1 where  id1='$bid' ";
...
echo  "<script type=\"text/javascript\"> 
   ...
   setTimeout(\"DoTheRedirect('bill_list2.php')\",parseInt(2*1000));
