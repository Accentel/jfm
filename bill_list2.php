                                        ...
                                        $start_from = ($page-1) * $results_per_page;
											if(isset($_POST['bsearch'])){
											 ...
											 $y="SELECT * FROM qot_bill where status='payment pending'  and quet_num like  '%$bsearch%'  ";
													...
													if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='apbilling') or  ($tsname=='Srujith.Nimmagadda') or ($tsname=='sumanthpotluri')or ($tsname=='naiduys') ){
											         $y="SELECT * FROM qot_bill where status='payment pending'  order by id asc  LIMIT $start_from,$results_per_page  ";
											    }else{
											         $y="SELECT * FROM qot_bill where status='payment pending' and user='$tsadmin' order by id asc  LIMIT $start_from,$results_per_page ";
											    }
...
echo date('d-m-Y', strtotime($d)); }?></td>
                                                       ...
                                                       <?php }?>
                                                        ...
                                                        <td class="hidden-480">
                                                             <?php  if(($tsname=='admin') or ($tsname=='durgarao')  or ($tsname=='apbilling')or ($tsname=='sumanthpotluri')){ ?>
                                                            <a href="generateinvoice.php?id=<?php echo $rs1['quet_num']; ?>">
                                                       ...
                                                       <?php }?>
                                                         ...
                                                         <td class="hidden-480">
                                                              <?php  if(($tsname=='admin') or ($tsname=='durgarao')  or ($tsname=='apbilling')or ($tsname=='sumanthpotluri')){ ?><a href="generateexcel.php?id=<?php echo $rs1['quet_num']; ?>"><img src="images/xl.jpg" width="20" height="20"></a>
                                                                  <?php }else{?>
...
if($bsearch!=''){
											 ...
											 $sql="SELECT count(1) as total FROM qot_bill where status='payment pending'  and quet_num like  '%$bsearch%'  ";
											} else {
													if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='apbilling') or  ($tsname=='Srujith.Nimmagadda') or ($tsname=='sumanthpotluri')or ($tsname=='naiduys') ){
											         $sql="SELECT count(1) as total FROM qot_bill where status='payment pending'    ";
											    }else{
											         $sql="SELECT count(1) as total FROM qot_bill where status='payment pending' and user='$tsadmin'  ";
											    }
...
{
if(($i+1)==$page) 
echo "<li><a href='bill_list2.php?page=".($i+1)."' class='button' style='color:red'>".($i+1)."</a></li>";
else
echo "<li><a href='bill_list2.php?page=".($i+1)."' class='button'>".($i+1)."</a></li>";
}
