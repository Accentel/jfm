...
function ConfirmDialog() {
  ...
  if (x) {
    ...
    function s2() {
			var curval = document.getElementById("qt_no1").value;
			$.ajax({
				type: "GET",
				url: "check_knqotno.php",
				data: {
					keyword: curval
				},
				success: function(data) {
 ...
 <input type="hidden" name="id" value="<?php echo $id?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
											...
											<tr>
											    ...
											    <td><input  type="text" readonly   class="form-control" value="QJFMKN<?php echo $cnt;?>" required name="qt_no" id="qt_no"></td>
											    <td align="right">Manual Quote NO</td>
											     <td><input  type="text"   class="form-control" value=""  name="qt_no1" id="qt_no1" onkeyup='s2()'>
