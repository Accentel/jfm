...
<td class="hidden-480"><?php 
                                                    ...
                                                    <?php    } ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="edit_status.php?id=<?php echo $rs1['quet_num']; ?>&id1=<?php echo $r1['id'];?>">
...
{
if(($i+1)==$page) 
echo "<li><a href='bill_list.php?page=".($i+1)."' class='button' style='color:red'>".($i+1)."</a></li>";
else
echo "<li><a href='bill_list.php?page=".($i+1)."' class='button'>".($i+1)."</a></li>";
}
