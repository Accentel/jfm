...
$email=$y1['emp_email'];
 ...
 $y=mysqli_query($link,"select * from admin_login where user='$name'");
 $y1=mysqli_fetch_array($y);
 $rolesvalues= $y1['Roles'];
 $roles=explode(",",$rolesvalues);
                  ...
                  <div class="col-sm-2"><b><a href="qut_oddoc_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
				   <div class="col-sm-3">
                                  ...
                                  <div style="overflow-x:auto;">
                                                    ...
                                                    <tr>
                                                       ...
                                                       <th>S No</th>
														...
														<th>Whom To be Invest</th>
														 <?php if( ($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='Sulfeekhar') 
                                                         or ($tsname=='manikandan') or ($tsname=='sumanthpotluri') or ($tsname=='JFMOD22232823') 
                                                         or in_array( 'DROD', $roles, 'False' ) ){?>
										...
										if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='odbilling') or ($tsname=='8919765662')
                                         or ($tsname=='sumanthpotluri') or ($tsname=='naiduys')  or ($tsname=='JFMOD22232823') or in_array( 'DROD', $roles, 'False' ) ){
						...
						$k12="select * from dpr where store_code='$str_code' and superwisor='$supervisor'";
                            ...
                            ?>
                            <?php if(($supervisor==$ename) or($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='odbilling') or ($tsname==$ses)
                             or ($tsname=='sumanthpotluri') or ($tsname=='naiduys')  or ($tsname=='JFMOD22232823') or in_array( 'DROD', $roles, 'False' ) ){?>
										 ...
										 while( $r2=mysqli_fetch_array($sr1)){
											  ...
											  //$req_amnt=$r2['req_amnt'];
                                                ...
                                                //    $apamt=$apamt+$req_amnt;
													 ...
													 <?php if( ($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='Sulfeekhar')
                                                      or ($tsname=='manikandan') or ($tsname=='sumanthpotluri') or ($tsname=='JFMOD22232823') or in_array( 'DROD', $roles, 'False' ) ){?>
<td class="hidden-480"><?php 
...
<td class="hidden-480"><?php 
                                                        ...
                                                        <td class="hidden-480">
                                                             ...
                                                             <?php if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='odbilling')or 
                                                             ($tsname=='sumanthpotluri')  or in_array( 'DROD', $roles, 'False' ) ){ ?>
                                                        ...
                                                        <?php }?>
                                                         <?php if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname==$ses) or 
                                                         ($tsname=='sumanthpotluri')  or in_array( 'DROD', $roles, 'False' ) ){ ?>
                                                    ...
                                                    <?php    } ?>
                                                        ...
                                                        <td>
														    ...
														    <?php if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname==$ses) or ($tsname=='sumanthpotluri')  or in_array( 'DROD', $roles, 'False' ) ){ ?>
